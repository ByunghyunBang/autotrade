...
if ticker == "DOGE":
    ...
    min_volume_to_buy = 10 * 1000 * 1000
elif ticker == "ETH":
    unit_price = 1000  # ETH
    min_diff_price_to_buy = 3000  # ETH
    min_volume_to_buy = 800  # ETH
elif ticker == "HIFI":
    unit_price = 1
    min_diff_price_to_buy = 2
    min_volume_to_buy = 4 * 1000 * 1000
else:  # XRP
    unit_price = 1
    min_diff_price_to_buy = 2
    min_volume_to_buy = 15 * 1000 * 1000
...
def get_target_price_to_sell(latest2_row):
    ...
    target_price = max(prev['close'] - height_k, min_loss_price)
    ...
    for i in range(len(df)):
        ...
        if time_to_buy and buy_condition(latest2_row):
            ...
            if sell_on_end:
                ...
                krw_balance, crypto_balance, total_krw = sell_routine(timestamp, krw_balance, crypto_balance, volume,
                                                                      amount, target_price, latest_krw_balance)
